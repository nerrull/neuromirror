...
#ifndef RacineShimmerConfig_H
#define RacineShimmerConfig_H
...
namespace RacineShimmerConfig
{
    static const unsigned short CompanyID = 64;
    static const unsigned short PluginID = 23742;
}

#endif // RacineShimmerConfig_H
