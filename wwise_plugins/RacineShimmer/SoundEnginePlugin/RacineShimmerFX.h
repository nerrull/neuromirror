...
#ifndef RacineShimmerFX_H
#define RacineShimmerFX_H
...
private:
    ...
    RacineShimmer::Settings CurrentSettings() const;

    RacineShimmerFXParams* m_pParams;
    AK::IAkPluginMemAlloc* m_pAllocator;
    AK::IAkEffectPluginContext* m_pContext;

    RacineShimmer::Processor m_dsp;
    RacineShimmer::Settings m_previousSettings;
    AkFXTailHandler m_tailHandler;
    AkReal32* m_pMemory;         ///< The whole tank, one allocation
    bool m_bSettingsPrimed;     ///< False until the first Execute seeds the ramp
};

#endif // RacineShimmerFX_H
