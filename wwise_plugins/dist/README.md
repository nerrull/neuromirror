...
Windows authoring DLLs (Release config, vc170/Wwise 2025.1.10 SDK) for all
seven plug-ins, built per the instructions in `../README.md`. Each `.dll` is
paired with the `.xml` property definition copied alongside it during the
build.
